...
--@Descripción:     Creación de sinónimos en el nodo hecbbdd_s2.

--################## SUCURSAL ##################
create or replace synonym sucursal_f1 for sucursal_f1_hcb_s1@hecbbdd_s1;
create or replace synonym sucursal_f2 for sucursal_f2_hcb_s2;
...
create or replace synonym sucursal_taller_f2 for sucursal_taller_f2_hcb_s2;
...
create or replace synonym sucursal_venta_f2 for sucursal_venta_f2_hcb_s2;
...
create or replace synonym laptop_f5 for laptop_f5_hcb_s2;
--################## LAPTOP INVENTARIO ##################
...
create or replace synonym historico_status_laptop_f1 for historico_status_laptop_f1_hcb_s2;
...
create or replace synonym servicio_laptop_f2 for servicio_laptop_f2_hcb_s2;
...
--################## TIPO PROCESADOR ##################
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_hcb_s2;
...
--################## TIPO TARJETA VIDEO ##################
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_hcb_s2;
...
--################## TIPO ALMACENAMIENTO ##################
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_hcb_s2;
...
--################## TIPO MONITOR ##################
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_hcb_s2;
