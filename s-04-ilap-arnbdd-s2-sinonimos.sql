...
--@Descripción:     Creación de sinónimos en el nodo arnbdd_s2.
...
create or replace synonym sucursal_f4 for sucursal_f4_arn_s2;
--################## SUCURSAL TALLER ##################
...
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_arn_s2;
--################## SUCURSAL VENTA ##################
...
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_arn_s2;
--################## LAPTOP ##################
create or replace synonym laptop_f1 for laptop_f1_arn_s2;
create or replace synonym laptop_f2 for laptop_f2_hcb_s1@hecbbdd_s1;
create or replace synonym laptop_f3 for laptop_f3_arn_s2;
...
create or replace synonym servicio_laptop_f4 for servicio_laptop_f4_arn_s2;
--################## TIPO PROCESADOR ##################
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_arn_s2;
...
create or replace synonym tipo_procesador_r4 for tipo_procesador_r_arn_s1@arnbdd_s1;
--################## TIPO TARJETA VIDEO ##################
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_arn_s2;
...
create or replace synonym tipo_tarjeta_video_r4 for tipo_tarjeta_video_r_arn_s1@arnbdd_s1;
--################## TIPO ALMACENAMIENTO ##################
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_arn_s2;
...
create or replace synonym tipo_almacenamiento_r4 for tipo_almacenamiento_r_arn_s1@arnbdd_s1;
--################## TIPO MONITOR ##################
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_arn_s2;
...
create or replace synonym tipo_monitor_r4 for tipo_monitor_r_arn_s1@arnbdd_s1;
