...
--@Descripción:     Definición de vistas con acceso a datos BLOB para el sitio arnbdd_s2.

create or replace view laptop as
  select lf1.laptop_id,q1.num_serie,q1.cantidad_ram,q1.caracteristicas_extras,
    q1.tipo_tarjeta_video_id,q1.tipo_procesador_id,q1.tipo_almacenamiento_id,
    q1.tipo_monitor_id,q1.laptop_reemplazo_id,lf1.foto
  from laptop_f1 lf1
  join(
  ...
  on lf1.laptop_id = q1.laptop_id;

create or replace view servicio_laptop as
  select num_servicio,laptop_id,importe,diagnostico,
    get_remote_factura_f1_by_id(num_servicio,laptop_id) as factura,sucursal_id
